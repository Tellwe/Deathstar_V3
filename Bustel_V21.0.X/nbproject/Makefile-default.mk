...
SOURCEFILES_QUOTED_IF_SPACED=SourceCode/main.c SourceCode/battery.c SourceCode/button.c SourceCode/configHW.c SourceCode/duskGuard.c SourceCode/flash.c SourceCode/ledBlink.c SourceCode/ledLight.c SourceCode/motionSensor.c SourceCode/rtc.c SourceCode/solarPanel.c SourceCode/transceiver.c SourceCode/longRangeTransceiver.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/SourceCode/main.p1 ${OBJECTDIR}/SourceCode/battery.p1 ${OBJECTDIR}/SourceCode/button.p1 ${OBJECTDIR}/SourceCode/configHW.p1 ${OBJECTDIR}/SourceCode/duskGuard.p1 ${OBJECTDIR}/SourceCode/flash.p1 ${OBJECTDIR}/SourceCode/ledBlink.p1 ${OBJECTDIR}/SourceCode/ledLight.p1 ${OBJECTDIR}/SourceCode/motionSensor.p1 ${OBJECTDIR}/SourceCode/rtc.p1 ${OBJECTDIR}/SourceCode/solarPanel.p1 ${OBJECTDIR}/SourceCode/transceiver.p1 ${OBJECTDIR}/SourceCode/longRangeTransceiver.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/SourceCode/main.p1.d ${OBJECTDIR}/SourceCode/battery.p1.d ${OBJECTDIR}/SourceCode/button.p1.d ${OBJECTDIR}/SourceCode/configHW.p1.d ${OBJECTDIR}/SourceCode/duskGuard.p1.d ${OBJECTDIR}/SourceCode/flash.p1.d ${OBJECTDIR}/SourceCode/ledBlink.p1.d ${OBJECTDIR}/SourceCode/ledLight.p1.d ${OBJECTDIR}/SourceCode/motionSensor.p1.d ${OBJECTDIR}/SourceCode/rtc.p1.d ${OBJECTDIR}/SourceCode/solarPanel.p1.d ${OBJECTDIR}/SourceCode/transceiver.p1.d ${OBJECTDIR}/SourceCode/longRangeTransceiver.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/SourceCode/main.p1 ${OBJECTDIR}/SourceCode/battery.p1 ${OBJECTDIR}/SourceCode/button.p1 ${OBJECTDIR}/SourceCode/configHW.p1 ${OBJECTDIR}/SourceCode/duskGuard.p1 ${OBJECTDIR}/SourceCode/flash.p1 ${OBJECTDIR}/SourceCode/ledBlink.p1 ${OBJECTDIR}/SourceCode/ledLight.p1 ${OBJECTDIR}/SourceCode/motionSensor.p1 ${OBJECTDIR}/SourceCode/rtc.p1 ${OBJECTDIR}/SourceCode/solarPanel.p1 ${OBJECTDIR}/SourceCode/transceiver.p1 ${OBJECTDIR}/SourceCode/longRangeTransceiver.p1

# Source Files
SOURCEFILES=SourceCode/main.c SourceCode/battery.c SourceCode/button.c SourceCode/configHW.c SourceCode/duskGuard.c SourceCode/flash.c SourceCode/ledBlink.c SourceCode/ledLight.c SourceCode/motionSensor.c SourceCode/rtc.c SourceCode/solarPanel.c SourceCode/transceiver.c SourceCode/longRangeTransceiver.c
...
${OBJECTDIR}/SourceCode/main.p1: SourceCode/main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit2  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/SourceCode/main.p1  SourceCode/main.c 
...
${OBJECTDIR}/SourceCode/longRangeTransceiver.p1: SourceCode/longRangeTransceiver.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/SourceCode" 
	@${RM} ${OBJECTDIR}/SourceCode/longRangeTransceiver.p1.d 
	@${RM} ${OBJECTDIR}/SourceCode/longRangeTransceiver.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit2  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/SourceCode/longRangeTransceiver.p1  SourceCode/longRangeTransceiver.c 
	@-${MV} ${OBJECTDIR}/SourceCode/longRangeTransceiver.d ${OBJECTDIR}/SourceCode/longRangeTransceiver.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/SourceCode/longRangeTransceiver.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/Bustel_V21.0.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Bustel_V21.0.X.${IMAGE_TYPE}.map  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Bustel_V21.0.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
